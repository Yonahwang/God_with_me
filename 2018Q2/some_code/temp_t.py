...
data = DataFrame(newX,columns=list('a''b''c''d''f''g''h''u''r''y''o''p'))
data['label'] = label
...
ax2 = plt.subplot(232)
x_values = data.loc[data['label']==0].c.tolist()
y_values = data.loc[data['label']==0].d.tolist()

x1_values = data.loc[data['label']==1].c.tolist()
y1_values = data.loc[data['label']==1].d.tolist()
plt.scatter(x_values, y_values, c = 'g',marker = '.')
plt.scatter(x1_values, y1_values, c = 'r',marker = '^')

ax3 = plt.subplot(233)
x_values = data.loc[data['label']==0].f.tolist()
y_values = data.loc[data['label']==0].g.tolist()

x1_values = data.loc[data['label']==1].f.tolist()
y1_values = data.loc[data['label']==1].g.tolist()
plt.scatter(x_values, y_values, c = 'g',marker = '.')
plt.scatter(x1_values, y1_values, c = 'r',marker = '^')

ax4 = plt.subplot(234)
x_values = data.loc[data['label']==0].h.tolist()
y_values = data.loc[data['label']==0].u.tolist()

x1_values = data.loc[data['label']==1].h.tolist()
y1_values = data.loc[data['label']==1].u.tolist()
plt.scatter(x_values, y_values, c = 'g',marker = '.')
plt.scatter(x1_values, y1_values, c = 'r',marker = '^')

ax4 = plt.subplot(235)
x_values = data.loc[data['label']==0].r.tolist()
y_values = data.loc[data['label']==0].y.tolist()

x1_values = data.loc[data['label']==1].r.tolist()
y1_values = data.loc[data['label']==1].y.tolist()
plt.scatter(x_values, y_values, c = 'g',marker = '.')
plt.scatter(x1_values, y1_values, c = 'r',marker = '^')

ax4 = plt.subplot(236)
x_values = data.loc[data['label']==0].o.tolist()
y_values = data.loc[data['label']==0].p.tolist()

x1_values = data.loc[data['label']==1].o.tolist()
y1_values = data.loc[data['label']==1].p.tolist()
plt.scatter(x_values, y_values, c = 'g',marker = '.')
plt.scatter(x1_values, y1_values, c = 'r',marker = '^')
